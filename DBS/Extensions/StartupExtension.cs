...
{
    private static readonly IOptions<FirebaseAdminConfig>? _firebaseAdminConfig;
    ...
    public static void ConfigureFirebaseServices(this IServiceCollection services, IConfiguration configuration)
    {
        var firebaseConfig = configuration.GetSection("FirebaseCredential").Get<FirebaseAdminConfig>();
